...
begin
     ...
     my_wwindow (2,22,80,25,'[HELP]','',false);
     write(' 1-8-> Eingänge ;Shift 1-8-> Zähler ; F9 -> Intern/Extern ; F10 -> Grafik');
     textbackground(lightgray);
     my_wwindow (2,2,80,21,'[RUN]','<ESC>',false);
...
{     grapherror:=graphresult;}
     ...
     GotoXY(1,17);write('Zykluszeit Tz=',time2:5:0,' ms');
     if mouseinstalled then begin
